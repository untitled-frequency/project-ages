...
export default function Index({ reunions, reunionsFuture }) {
    const reunionList = reunions?.data || [];
    const reunionFutureList = reunionsFuture?.length || 0;
            ...
            <div className="max-w-7xl mx-auto space-y-6">
                ...
                <div className="flex justify-between items-center">
                    <h2 className="text-lg text-gray-500 font-semibold">
                        {reunionFutureList.length > 0 ? `${reunionFutureList} réunion${reunionFutureList > 1 ? 's' : ''} à venir` : 'Aucune réunion à venir'}
                    </h2>
                    <Link 
