...
import { FilePen, User, ArrowLeft, Save } from "lucide-react";

export default function Edit({ contribution, user, paie }) {
    // Only bind montant to form state since only montant is updated
    ...
    return (
        ...
        >
            <Head title="Modifier une Contribution" />

            <div className="p-6 max-w-3xl mx-auto space-y-6">
                <div className="bg-white shadow rounded-lg p-6 space-y-6">
                    
                    {/* Read-only User Banner (Informative only) */}
