...
export default function ContributionCreate() {
    ...
    return (
        ...
        >
            <Head title="Définir la contribution" />

            <div className="p-4 sm:p-6 max-w-2xl mx-auto space-y-6">
                <DefaultButton href={route('contribution.index')} className="inline-flex items-center gap-2 w-fit">
                ...
                >
                    <p className="text-sm text-gray-500">
                        Ce montant s'applique à l'année en cours et détermine ce que chaque membre
                        doit régler en fonction de son statut (membre simple ou membre du bureau).
                    </p>
                    ...
                    <div>
                        ...
                        {errors.annee_id && (
                            <p className="text-xs text-rose-600 mt-1">{errors.annee_id}</p>
                        )}
                    </div>
